...
CREATE TYPE marital_status_enum AS ENUM ('Married', 'Single', 'Divorced', 'Separated', 'Widowed', 'Unmarried', 'unknown');
...
CREATE TYPE school_college_enum AS ENUM ('School', 'College', 'None', 'unknown');
